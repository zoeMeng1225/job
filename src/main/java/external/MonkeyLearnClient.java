...
public class MonkeyLearnClient {
	private static final String API_KEY = "c4c2aece3c28cc1908f2192116bb3fb2892a65a7";// api key;
	private static final String MODEL = "ex_YCya9nrn"; // model
	...
	private static List<List<String>> getKeywords(JSONArray mlResultArray){
		...
		for (int i = 0; i < mlResultArray.size(); ++i) {
			...
			//second loop for each elements in this document;
			for (int j = 0; j < keywordsArray.size(); ++j) {
				JSONObject keywordObject = (JSONObject) 
				keywordsArray.get(j);
